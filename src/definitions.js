...
export const SHOP_ITEMS = [
  ...
  { id: 'protective-rosary', shop: 1, name: '護りの数珠', price: 2, effect: '自分がこの駅で受ける直接ダメージを合計1軽減。', stock: 1 },
  { id: 'red-bandage', shop: 1, name: '赤い包帯', price: 3, effect: 'カード処理終了後、自分HP＋1。', stock: 1 },
  { id: 'needle-ward', shop: 2, name: '針除けの護符', price: 3, effect: '自分がこの駅で受ける直接ダメージを合計1軽減。', stock: 1 },
  { id: 'decoy-doll', shop: 2, name: '囮人形', price: 2, effect: '自分を対象とした最初の対象変更を無効化。', stock: 1 },
  { id: 'demon-eye', shop: 2, name: '鬼の眼', price: 3, effect: '最終確認前、指定PL1人の仮選択カードの主分類を見る。', stock: 1 },
  { id: 'accomplice-thread', shop: 2, name: '共犯の糸', price: 2, effect: '自分の攻撃対象を指定PL1人へ秘密に通知。', stock: 1 },
  { id: 'scapegoat-slip', shop: 2, name: '身代わり札', price: 3, effect: '自分が最初に受ける直接攻撃を2軽減。', stock: 1 },
  { id: 'grudge-slip', shop: 2, name: '怨返しの札', price: 2, effect: '自分へ直接ダメージを与えた相手1人へHP−1。', stock: 1 },
  { id: 'hell-key', shop: 2, name: '地獄の鍵', price: 3, effect: 'そのターン、七獄カード1枚の通常CTを無視。', stock: 1 },
  { id: 'bloodstop-charm', shop: 3, name: '血止めの護符', price: 5, effect: 'このターン、自分が受ける反撃・反射ダメージを合計2軽減。', stock: 1 },
  { id: 'shared-life-cup', shop: 3, name: '共命の杯', price: 7, effect: '自分の七獄カードによる他PLへの回復量＋1。', stock: 1 },
  { id: 'blood-divination-needle', shop: 3, name: '血占いの針', price: 8, effect: '指定PLの仮選択カードが攻撃か、それ以外か確認。', stock: 1 },
  { id: 'leftover-bag', shop: 4, name: '食い残し袋', price: 8, effect: '完全不発または攻撃部分を無効化された場合、処理終了後HP＋1。', stock: 1 },
  { id: 'hunger-lock', shop: 4, name: '餓鬼の錠前', price: 7, effect: 'このターン、選択カードは新たなCOOLDOWN_EXTENSIONを受けない。', stock: 1 },
  { id: 'greedy-ticket', shop: 4, name: '欲張り札', price: 5, effect: '指定カードの次回使用後に発生する通常CTを1回だけ無視。', stock: 1 },
  { id: 'war-mask', shop: 5, name: '修羅の面', price: 7, effect: 'このターン、自分が最初に受ける反撃・反射ダメージを0にする。', stock: 1 },
  { id: 'hell-chain', shop: 5, name: '地獄の鎖', price: 5, effect: 'このターン、自分の七獄カードの最終対象を変更されなくする。', stock: 1 },
  { id: 'battle-medicine', shop: 5, name: '戦傷薬', price: 3, effect: '他PLから直接実ダメージを合計2以上受けた場合、処理終了後HP＋2。', stock: 1 },
