...
export const SHOP_ITEMS = [
  ...
  { id: 'protective-rosary', shop: 1, name: '護りの数珠', price: 2, effect: 'このターン、自分が受ける直接ダメージを合計1軽減。', effectType: 'DIRECT_REDUCTION', stock: 1 },
  ...
  { id: 'scapegoat-slip', shop: 2, name: '身代わり札', price: 3, effect: '自分が最初に受ける直接攻撃を2軽減。', effectType: 'FIRST_DIRECT_REDUCTION', stock: 1 },
  { id: 'grudge-slip', shop: 2, name: '怨返しの札', price: 2, effect: '秘密指定したPLから直接実ダメージを受けた場合、カード処理後にHP−1。', effectType: 'GRUDGE', stock: 1 },
  { id: 'hell-key', shop: 2, name: '地獄の鍵', price: 3, effect: 'そのターン、七獄カード1枚の通常CTを無視。', effectType: 'NORMAL_CT_BYPASS', stock: 1 },
  ...
  { id: 'blood-divination-needle', shop: 3, name: '血占いの針', price: 8, effect: '最終確認前、指定PLの仮選択カードが攻撃か、それ以外か確認。', effectType: 'INFO_ATTACK_OR_OTHER', timing: 'info', stock: 1 },
  ...
  { id: 'hell-chain', shop: 5, name: '地獄の鎖', price: 5, effect: 'このターン、自分の七獄カードの最終対象を変更されなくする。', effectType: 'PREVENT_TARGET_CHANGE', stock: 1 },
  ...
  { id: 'six-realms-chain', shop: 6, name: '六道の鎖', price: 5, effect: 'このターン、自分の七獄カードは対象変更を受けない。', effectType: 'PREVENT_TARGET_CHANGE', stock: 1 },
